...
export default function Navbar(){
    ...
    <nav className="flex justify-between w-full p-2">
        <div>
            <h1 className="text-xl text-[rgba(255,195,18,1)]">WatchParty</h1>
        </div>
     ...
     ease-[cubic-bezier(0.895,0.03,0.685,0.22)]
            ...
            <img src="/icons/reject.svg" alt="menus" className={`w-full absolute top-1 max-w-[25px] transition-all duration-300
     ease-[cubic-bezier(0.895,0.03,0.685,0.22)]
