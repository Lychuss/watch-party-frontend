...
export default function Home(){
  ...
  border-b-2 border-black">
    ...
    opacity-0 animate-[fadeUp_0.8s_ease-out_forwards]"></img>
    <img src="/icons/paper-plane.svg" alt="thunder" className="w-[80px] absolute top-20 left-2 z-1
    opacity-0 animate-[fadeUp_1s_ease-out_forwards]"></img>
    <img src="/icons/flash.svg" alt="flash" className="w-[80px] absolute top-15 right-0 z-1
    opacity-0 animate-[fadeUp_1.2s_ease-out_forwards]"></img>
    <Labels label="Stream Watch Together" bg="bg-[rgba(247,74,163,0.8)] opacity-0 
    animate-[fadeUp_1.5s_ease-out_forwards]"></Labels>
  </div>
  <div className="flex flex-col p-2 bg-[rgba(249,199,79,1)] gap-5 border-b-2 border-black">
    <h1 className="text-5xl font-extrabold mt-3 opacity-0 
    animate-[fadeUp_1.5s_ease-out_forwards]">Where Friends Meet Online</h1>
